...
class LSTM(torch.nn.Module):
    def __init__(self, input_size=30, hidden_layer_size=10, output_size=1):
        ...
        self.fc1 = torch.nn.Linear(hidden_layer_size, output_size)
    ...
    def forward(self, input_):
        ...
        out = lstm_out.view(len(input_), -1)
        mean = self.fc1(out)
        # mean = self.relu(mean)
...
def predict(guide,X,uncertainty=False,num_sample1=20,num_sample2=20):
