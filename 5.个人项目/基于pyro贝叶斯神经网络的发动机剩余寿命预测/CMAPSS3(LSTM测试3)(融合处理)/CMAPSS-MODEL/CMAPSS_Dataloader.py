...
class train_dataset(Dataset):
    def __init__(self, read_path, sub_dataset, window_size, max_life, scaler, scaler_range, fusion):
...
def LoadCMAPSS(read_path, sub_dataset, window_size, max_life, scaler, scaler_range, shuffle, batch_size, fusion=False):
    ...
    if shuffle:
        ...
        tr_dataset = train_dataset(read_path, sub_dataset, window_size, max_life, scaler, scaler_range, fusion)
    ...
    te_dataset = test_dataset(read_path, sub_dataset,  window_size, max_life, scaler, scaler_range, fusion)
    print('\t Length of test data: ', len(te_dataset))
    test_loader = DataLoader(te_dataset, batch_size, shuffle=False)

    finalte_dataset = finaltest_dataset(read_path, sub_dataset,  window_size, max_life, scaler, scaler_range, fusion)
