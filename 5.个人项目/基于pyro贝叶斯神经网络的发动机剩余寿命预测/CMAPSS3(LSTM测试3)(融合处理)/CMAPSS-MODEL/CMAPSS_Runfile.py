...
train_loss_epoch, test_loss_epoch, train_output, test_output, finaltest_output = CMAPSS_CNN.train(model.model,model.guide,train_loader, test_loader,unshuffle_train_loader,finaltest_loader,num_iter,fusion)
...
#                                                                                        loss_func,
#                                                                                        num_epochs)
CMAPSS_PlotFunctions.train_actual_predicted(read_path, sub_dataset, window_size, max_life, fusion, train_output, alpha_grid, alpha_low, alpha_high, _COLORS)
CMAPSS_PlotFunctions.test_actual_predicted(read_path, sub_dataset, window_size, max_life, fusion, test_output, alpha_grid, alpha_low, alpha_high, _COLORS)
CMAPSS_PlotFunctions.loss_plot(sub_dataset, train_loss_epoch, test_loss_epoch, alpha_grid, alpha_low, alpha_high, _COLORS)
socre = CMAPSS_PlotFunctions.fianltest_actual_vs_predicted(read_path, sub_dataset, window_size, max_life, fusion, finaltest_output, alpha_grid, alpha_low, alpha_high, _COLORS, finalte_dataset)
#
